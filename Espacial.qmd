---
title: Modelado Geoespacial # Cambiar
...
library(gstat)
library(maptools)
Data = data.frame(PolucionUK[, 1:2], res = mod1$residuals)
...
cvMCOWM = krige.cv(res ~ 1, Data, ve.fit1WM, maxdist = 450000) 
...
#| results: hide
library(viridis)
PM10preMCO=krige(res ~ 1,Data,muestra1, ve.fit1WM, nsim=0)
PM10preMCP=krige(res ~ 1,Data,muestra1, ve.fit2WM)
PM10preMCPCressie=krige(res ~ 1,Data,muestra1, ve.fit3WM)
PM10preMV=krige(res ~ 1,Data,muestra1, ve.fit4WM)
PM10preMVRe=krige(res ~ 1,Data,muestra1, ve.fit5WM)
